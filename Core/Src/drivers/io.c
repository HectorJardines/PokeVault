...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	...
	[IO_SPI_CS_MFRC] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_10, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_W5500] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_10, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},

 ...
 * Size: 8 px
 * Bpp: 1
 * Opts: --bpp 1 --size 8 --no-compress --font ..\..\..\..\projects\unscii-8.ttf --range 32-127 --format lvgl
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_unscii_8 = {
#else
lv_font_t ui_font_unscii_8 = {
#endif

...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	...
	// I2C SDA/SCL PINS
	[IO_I2C1_SCL] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_8, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_OD, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE4, .PIN_OUT = IO_OUT_HIGH}},
	[IO_I2C1_SDA] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_7, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_OD, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE4, .PIN_OUT = IO_OUT_HIGH}},
	...
	// IR EMITTERS
	[IO_IR_EMIT] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_12, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	
	// BMI160 IMU INTERRUPT PINS
	[IO_INT_ANYM] = {.GPIOx = GPIOC, {.PIN_NO = IO_PIN_14, .PIN_MODE = IO_MODE_INPUT, .PIN_OPTYPE = IO_OPTYPE_OD, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_LOW}},
	[IO_INT_DTAP] = {.GPIOx = GPIOC, {.PIN_NO = IO_PIN_15, .PIN_MODE = IO_MODE_INPUT, .PIN_OPTYPE = IO_OPTYPE_OD, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_LOW}},
	...
	// IR SENSOR PINS
	[IO_IR_RCV] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_0, .PIN_MODE = IO_MODE_INPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM}},
	[IO_PIR_RCV] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_1, .PIN_MODE = IO_MODE_INPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM}},
	...
	[IO_UNUSED_7] = UNUSED_IO_CONFG(GPIOA, IO_PIN_7), [IO_UNUSED_8] = UNUSED_IO_CONFG(GPIOA, IO_PIN_8), [IO_UNUSED_9] = UNUSED_IO_CONFG(GPIOA, IO_PIN_9), 
	...
	[IO_UNUSED_25] = UNUSED_IO_CONFG(GPIOB, IO_PIN_11), [IO_UNUSED_26] = UNUSED_IO_CONFG(GPIOB, IO_PIN_14), [IO_UNUSED_27] = UNUSED_IO_CONFG(GPIOB, IO_PIN_13), 
	[IO_UNUSED_29] = UNUSED_IO_CONFG(GPIOB, IO_PIN_15),
	...
	[IO_UNUSED_41] = UNUSED_IO_CONFG(GPIOC, IO_PIN_11), [IO_UNUSED_42] = UNUSED_IO_CONFG(GPIOC, IO_PIN_12), [IO_UNUSED_45] = UNUSED_IO_CONFG(GPIOC, IO_PIN_13)
};
...
uint8_t io_get_out(io_e io) {
	return (io_confgs[io].GPIOx->IDR & (0x1 << io_confgs[io].IO_Confg.PIN_NO) >> io_confgs[io].IO_Confg.PIN_NO);
}

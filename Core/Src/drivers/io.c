...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	...
	//UNUSED PINS PORTA
	[IO_UNUSED_0] = UNUSED_IO_CONFG(GPIOA, IO_PIN_0), [IO_UNUSED_7] = UNUSED_IO_CONFG(GPIOA, IO_PIN_9), 
	...
	//UNUSED PINS PORTB
	[IO_UNUSED_17] = UNUSED_IO_CONFG(GPIOB, IO_PIN_3), [IO_UNUSED_18] = UNUSED_IO_CONFG(GPIOB, IO_PIN_4),

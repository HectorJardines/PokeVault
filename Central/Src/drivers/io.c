...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	...
	[IO_SPI_CS_MFRC] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_6, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_W5500] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_11, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_DISP] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_7, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_SD] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_8, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_TOUCH] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_1, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},

	// SPI2 PINS
	[IO_SPI2_SCK] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_13, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE5, .PIN_OUT = IO_OUT_NULL}},
	[IO_SPI2_MISO] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_14, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE5, .PIN_OUT = IO_OUT_NULL}},
	[IO_SPI2_MOSI] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_15, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE5, .PIN_OUT = IO_OUT_NULL}},

	//RS485 PINS
	[IO_UART1_TX] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_6, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE7}},
	[IO_UART1_RX] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_10, .PIN_MODE = IO_MODE_ALT_FUN, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_ALT_FUN_MODE = IO_ALT_FUN_MODE7}},

	// IR SENSOR PINS
	[IO_DISP_CTL] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_0, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM}},

	// TOUCH DISPLAY PIN
	[IO_TOUCH_IT] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_0, .PIN_MODE = IO_MODE_INPUT, .PIN_OPTYPE = IO_OPTYPE_OD, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_FAST}},

	[IO_DBG_A] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_1, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM}},
	[IO_DBG_B] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_4, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_PU, .PIN_SPEED = IO_SPEED_MEDIUM}},

	//UNUSED PINS PORTA
	[IO_UNUSED_9] = UNUSED_IO_CONFG(GPIOA, IO_PIN_9), 
	[IO_UNUSED_12] = UNUSED_IO_CONFG(GPIOA, IO_PIN_12), [IO_UNUSED_13] = UNUSED_IO_CONFG(GPIOA, IO_PIN_13),
	[IO_UNUSED_14] = UNUSED_IO_CONFG(GPIOA, IO_PIN_14), [IO_UNUSED_15] = UNUSED_IO_CONFG(GPIOA, IO_PIN_15),

	//UNUSED PINS PORTB
	[IO_UNUSED_18] = UNUSED_IO_CONFG(GPIOB, IO_PIN_4),
	[IO_UNUSED_25] = UNUSED_IO_CONFG(GPIOB, IO_PIN_11), [IO_UNUSED_26] = UNUSED_IO_CONFG(GPIOB, IO_PIN_12),

	//UNUSED PINS PORTC
	[IO_UNUSED_27] = UNUSED_IO_CONFG(GPIOC, IO_PIN_0), [IO_UNUSED_28] = UNUSED_IO_CONFG(GPIOC, IO_PIN_1), [IO_UNUSED_34] = UNUSED_IO_CONFG(GPIOC, IO_PIN_4), [IO_UNUSED_35] = UNUSED_IO_CONFG(GPIOC, IO_PIN_5), 
...
uint8_t io_get_out(io_e io) {
	return io_confgs[io].GPIOx->ODR & (0x1 << io_confgs[io].IO_Confg.PIN_NO);;
}

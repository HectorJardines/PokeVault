...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	...
	[IO_SPI_CS] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_10, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	...
	[IO_IR_EMIT_UNIT3] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_11, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_LOW}},
	...
	[IO_UNUSED_47] = UNUSED_IO_CONFG(GPIOC, IO_PIN_15), [IO_UNUSED_12] = UNUSED_IO_CONFG(GPIOA, IO_PIN_12), [IO_UNUSED_13] = UNUSED_IO_CONFG(GPIOA, IO_PIN_13),

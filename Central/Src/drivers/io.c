...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	...
	[IO_SPI_CS_MFRC] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_6, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_W5500] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_11, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_DISP] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_7, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_SD] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_8, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	[IO_SPI_CS_TOUCH] = {.GPIOx = GPIOB, {.PIN_NO = IO_PIN_1, .PIN_MODE = IO_MODE_OUTPUT, .PIN_OPTYPE = IO_OPTYPE_PP, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM, .PIN_OUT = IO_OUT_HIGH}},
	...
	// TOUCH DISPLAY PIN
	[IO_TOUCH_IT] = {.GPIOx = GPIOA, {.PIN_NO = IO_PIN_0, .PIN_MODE = IO_MODE_INPUT, .PIN_OPTYPE = IO_OPTYPE_OD, .PIN_RESISTANCE = IO_RES_NOPUPD, .PIN_SPEED = IO_SPEED_MEDIUM}},

	//UNUSED PINS PORTA
	[IO_UNUSED_1] = UNUSED_IO_CONFG(GPIOA, IO_PIN_1), [IO_UNUSED_4] = UNUSED_IO_CONFG(GPIOA, IO_PIN_4), 
